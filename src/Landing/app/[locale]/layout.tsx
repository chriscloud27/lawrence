...
const THEME_INIT_SCRIPT = `(function(){try{var t=localStorage.getItem("lw-theme");if(!t){t=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";}document.documentElement.setAttribute("data-theme",t);}catch(e){}})();`;
